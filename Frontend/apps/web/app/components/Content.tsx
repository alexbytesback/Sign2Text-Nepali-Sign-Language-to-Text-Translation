      ...
      <div className={`md:flex ${isReversed ? 'md:flex-row-reverse' : ''} md:gap-16`}>
        <div className="self-center md:basis-1/2">
          ...
          <ItemGrid
            ...
            iconClass="flex-shrink-0 w-7 h-7 flex items-center justify-center rounded-full bg-green-500 text-gray-50 mr-4 rtl:mr-0 rtl:ml-4 mt-1 p-1"
          />
        </div>
        <div aria-hidden="true" className="mt-10 md:mt-0 md:basis-1/2">
          {image && (
            <div className="relative m-auto max-w-4xl">
              <Image
                className="mx-auto w-full rounded-lg shadow-lg bg-gray-400 dark:bg-green-500"
                src={image.src}
                width={828}
                height={828}
                alt={image.alt}
