                ...
                href && (
                  ...
                  >
                    <a
                      ...
                      className="flex items-center justify-center rounded-sm bg-transparent p-0.5 text-green-600 hover:bg-green-500 hover:text-slate-200 hover:dark:bg-slate-800 hover:dark:text-slate-200"
                    >
